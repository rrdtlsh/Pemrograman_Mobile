...
fun RootNavigation() {
    ...
    NavHost(navController = navController, startDestination = "splash") {
        ...
        // PERBAIKAN: Teruskan navController ke MainScreen
        composable("main") {
        ...
        composable(
            ...
            // NavController di sini sudah benar, tidak perlu diubah
...
// PERBAIKAN: Terima kedua NavController
@Composable
fun AppNavigation(bottomBarNavController: NavHostController, rootNavController: NavHostController) {
    // NavHost ini menggunakan controller khusus bottom bar
    NavHost(bottomBarNavController, startDestination = BottomNavItem.Home.route) {
        composable(BottomNavItem.Home.route) {
            // PERBAIKAN: PokemonListScreen menggunakan rootNavController agar bisa ke halaman detail
